...
###Import data
data_200 = pd.read_csv("/Users/eileenschilliger/PycharmProjects/projectHADES/Einzugsgebiete_150m.csv", sep=";")
...
for x in criteriachosenbyuser:
    ...
    print('the quantilles of the chosen catchment-id are:')
    print(quantilliste)
